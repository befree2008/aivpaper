...
if __name__ == "__main__":
    ...
    # http://export.arxiv.org/api/query?search_query=ti:Neural%20Architecture%20Search:%20A%20Survey&max_results=1
    ...
    for i in range(args.start_index, args.max_index, args.results_per_iteration):
        ...
        if len(parse.entries) == 0:
            ...
            print(response)
            args.wait_time = args.wait_time * 2
        ...
        # save the database every iteration, if we found anything new
        if num_added > 0:
